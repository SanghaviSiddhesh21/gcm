...
var deleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return runDelete(cmdTel, args)
	},
}

func runDelete(tel telemetry.Recorder, args []string) (err error) {
	defer func() { tel.Record("cmd_delete", map[string]any{"success": err == nil}) }()
