...
var assignCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		return runAssign(cmdTel, args)
	},
}

func runAssign(tel telemetry.Recorder, args []string) (err error) {
	defer func() { tel.Record("cmd_assign", map[string]any{"success": err == nil}) }()
